...
<html>
	...
	<body>
		...
		<div id="about" class="container panel hauptbereich seite-fuellen">
			<h1 class="panel-heading col-sm-offset-4 col-sm-4 text-center">Datenschutz</h1>
			...
			<div class="panel-body col-sm-12">
				<div class="col-sm-12">
					...
					<p>
						...
						von
						Daten
						gemäß der nachfolgenden Beschreibung einverstanden. Unsere Website kann grundsätzlich ohne
						Registrierung
						besucht werden. Dabei werden Daten wie beispielsweise aufgerufene Seiten bzw. Namen der
						abgerufenen
						Datei,
						Datum und Uhrzeit zu statistischen Zwecken auf dem Server gespeichert, ohne dass diese Daten
						unmittelbar auf
				...
				<div class="col-sm-12">
					...
					<p>
						...
						Endgerät des
						Nutzers spezifische, auf den Nutzer bezogene Informationen zu speichern, während er die Website
						nutzt.
						...
						gestalten.
						Cookies bleiben über das Ende einer Browser-Sitzung gespeichert und können bei einem erneuten
						Seitenbesuch
